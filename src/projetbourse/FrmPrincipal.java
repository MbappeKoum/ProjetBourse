...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        mesTraders = new ArrayList<>();
         ...
         Trader trad1 = new Trader(1,"Paul");
        Trader trad2 = new Trader(2,"Melvin");
        Trader trad3 = new Trader(3,"Simon");
        Trader trad4 = new Trader(4,"Dan");
        ...
        for(Trader trad: mesTraders)
        {
            if(trad.getIdTrader() == numTrader)
           {
               for(Action act : trad.getlesActions())
               {
                   ...
                   v.add(act.getvaleurReel());
                   v.add(act.getvaleurAchat());
                   v.add(act.getQuantiteAchat());
                   dtmActions.addRow(v);
                   prixTotal =  (double)(prixTotal + (act.getvaleurReel()*act.getvaleurAchat())-(act.getvaleurAchat()*act.getvaleurAchat()));
               }
           }
        }
    ...
    Action = Integer.parseInt(tblTraders.getValueAt(tblTraders.getSelectedRow(), 0).toString());   
        ...
        for(Trader trad : mesTraders)
        {
            for(Action act : trad.getlesActions())
            {
                if(act.getvaleurReel()<act.getvaleurAchat())
                {
                    argent = (act.getvaleurReel()*act.getQuantiteAchat())-(act.getvaleurAchat()*act.getQuantiteAchat());
                    lblMessage.setText("Vous perdez de l'argent l'action :"+argent);
                }
                else if(act.getvaleurReel()>act.getvaleurAchat())
                {
                    argent = (act.getvaleurReel()*act.getQuantiteAchat())-(act.getvaleurAchat()*act.getQuantiteAchat());
                    lblMessage.setText("Vous gagnez de l'argent sur  l'action :"+argent);
                }
            }
        }
